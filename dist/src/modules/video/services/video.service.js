...
let VideoService = class VideoService {
    ...
    createVideo(videoDto) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const errors = video_validation_1.VideoValidator.validateCreateVideoInput(videoDto);
                if (errors.length) {
                    return {
                        errors,
                        video: null,
                ...
                return {
                    errors,
                    video: yield this.videoRepository.create(videoDto),
                };
            }
            catch (error) {
    ...
    updateVideo(id, updatedVideo) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                return {
                    errors,
                    video: yield this.videoRepository.update(id, updatedVideo),
                    isVideo: Boolean(yield this.videoRepository.findById(id)),
                };
            }
            catch (error) {
...
exports.VideoService = VideoService = __decorate([
    ...
    __param(0, (0, inversify_1.inject)(service_identifiers_consts_1.SERVICE_IDENTIFIER.VideoRepository)),
