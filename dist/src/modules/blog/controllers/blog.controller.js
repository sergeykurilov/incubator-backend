...
let BlogController = class BlogController extends base_controller_1.BaseController {
    constructor(blogService, loggerService) {
        super(loggerService);
        ...
        this.bindRoutes([
            ...
            },
            {
                ...
                func: this.create,
                middlewares: [new auth_guard_1.AuthGuard(), new entity_guard_1.EntityGuard(blog_dto_1.BlogDto)],
            },
            {
                path: "/:id",
    ...
    getAll(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const blogs = yield this.blogService.findAll();
                res.json(blogs);
            }
            catch (error) {
                next(error);
    ...
    create(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                yield this.blogService.create(req.body);
                this.created(res);
            }
            catch (error) {
                next(error);
    ...
    update(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                yield this.blogService.update(String(req.params.id), req.body);
                this.created(res);
            }
            catch (error) {
                next(error);
    ...
    getById(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const blog = yield this.blogService.findById(String(req.params.id));
    ...
    deleteById(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const video = yield this.blogService.deleteById(String(id));
    ...
    deleteAll(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                yield this.blogService.deleteAll();
